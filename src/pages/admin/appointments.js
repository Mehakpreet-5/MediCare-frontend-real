...
//             // Fetch the updated list of bookings after submitting
//             const updatedResponse = await fetch('/api/book');
...
//                 <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg">
//                     <input
//                         type="text"
//                         name="name"
...
//                     <button
//                         type="submit"
//                         className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none col-span-2"
//                     >
//                         Book Appointment
//                     </button>
//                 </form>

//                 <h2 className="text-xl font-semibold mt-8">Existing Appointments</h2>
...
//                             <p>Meeting ID: {booking.meetingID}</p> {/* Display Meeting ID here */}
