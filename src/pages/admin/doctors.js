...
//         <h1 className="text-3xl font-bold mb-8">Doctors List</h1>
//    {/* Add Doctor Form */}
//    <form className="mb-8" onSubmit={handleAddDoctor}>
...
//             <h2 className="text-2xl font-semibold mb-6">{categoryData.category}</h2>

//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {/* Loop through doctors */}
//               {categoryData.doctors.map((doctor, doctorIndex) => (
//                 <div key={doctorIndex} className="border p-4 w-full rounded-lg shadow-lg">
//                   <img
//                     src={doctor.image}
//                     alt={doctor.name}
